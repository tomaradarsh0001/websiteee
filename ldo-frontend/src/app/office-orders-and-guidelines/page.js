...
const Page = () => {
  ...
  const { lang } = useContext(LangContext);
    ...
    const columns = [
      ...
      useEffect(() => {
          const fetchData = async () => {
              try {
                  const response = await fetch(API_HOST + 'officeDocs/3/' + lang)
    ...
    <div className="contact-us">
      <PageHeader pageTitle={lang == "hindi" ? "कार्यालय आदेश एवं दिशानिर्देश":"Office Orders & Guidelines"} language={lang} />
    ...
    <div className='w-full px-4'>
        ...
        <h2 className='themeTitle text-2xl lg:text-4xl font-bold text-center'>{lang == "hindi" ? "कार्यालय आदेश एवं दिशानिर्देश":"Office Orders & Guidelines"}</h2>
        </div>
    </div>
</div>
